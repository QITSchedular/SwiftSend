...
var chartRadialbarBasicColors = getChartColorsArray("basic_radialbar"),
    chartRadialbarMultipleColors =
        (chartRadialbarBasicColors &&
            ((options = { series: [70], chart: { height: 350, type: "radialBar" }, plotOptions: { radialBar: { hollow: { size: "70%" } } }, labels: ["Cricket"], colors: chartRadialbarBasicColors }),
    ...
    chartRadialbarGradientColors =
        (chartRadialbarCircleColors &&
            ((options = {
                series: [76, 67, 61, 55],
                chart: { height: 350, type: "radialBar" },
                plotOptions: { radialBar: { offsetY: 0, startAngle: 0, endAngle: 270, hollow: { margin: 5, size: "30%", background: "transparent", image: void 0 }, dataLabels: { name: { show: !1 }, value: { show: !1 } } } },
    ...
    chartStorkeRadialbarColors =
        (chartRadialbarGradientColors &&
            ((options = {
                ...
                fill: { type: "gradient", gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: chartRadialbarGradientColors, inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [0, 100] } },
...
(chartStorkeRadialbarColors = getChartColorsArray("stroked_radialbar")) &&
    ((options = {
        ...
        plotOptions: {
            radialBar: {
                hollow: { margin: 15, size: "65%", image: "./assets/images/comingsoon.png", imageWidth: 56, imageHeight: 56, imageClipped: !1 },
                dataLabels: { name: { show: !1, color: "#fff" }, value: { show: !0, color: "#333", offsetY: 65, fontSize: "22px" } },
            },
        },
